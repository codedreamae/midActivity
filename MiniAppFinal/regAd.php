...
<body class="bg-success">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                                    ...
                                    <a href="logAd.php" class="nav-link">Login</a>
    ...
    <div class="justify-content-center">
        ...
        <div class="card justify-content-center mt-3 bg-warning-subtle" style="width: 30rem;"> 
  <div class="card-body">
            <div class="mb-3">
            ...
            <div class="mb-3 mt-1 ">
                <button class="btn btn-warning float-end mb-2" name="registerAdmin">Register</button>
            </div>
  </div>
        </div>
        </form>
