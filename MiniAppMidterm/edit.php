...
<body class="bg-danger-subtle">
	<div class="row justify-content-center">
    	<div class="col-md-5">
				...
				<div class="card justify-content-center mt-5" style="width: 30rem;"> 
  <div class="card-body">
  <h3 class="text-primary text-center">RMB EXPRESS</h3>
    				...
    				<div class="form-group">
    					...
    					<input class="form-control" type="text" value="<?php echo $row['tracking']?>" name="tracking"/>
    				</div>
					<div class="form-group float-end">
                <button type="submit" name="update" class="btn btn-warning mt-2">Update</button>
                    <a href="index.php" class="btn btn-danger float-end m-2">Exit</a> 
    				</div>
  				</div>
				</div>
    			</form>
